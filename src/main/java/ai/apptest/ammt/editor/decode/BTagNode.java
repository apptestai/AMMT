...
public class BTagNode extends BXMLNode {
	...
	public void readEnd(IntReader reader) throws IOException{
		...
		if((ns_uri != mRawNSUri) || (name != mRawName) ){
			throw new IOException("Invalid end element(BTagNode): " + ns_uri + " != " + mRawNSUri + " || " + name + " != " + mRawName);
		}
	}
	...
	public Attribute getAttributeForKey(int key) {
...
//			}
//		}
		Attribute attr = this.getAttributeForKey(key);
		if (attr != null) {
			return attr.mString;
		}
