package ai.apptest.ammt.editor.decode;
...
//			MODIFIED BY MO: support such as " <amazon:enable-feature android:name="com.amazon.device.messaging" android:required="false"/> "
//			throw new IOException("Warning => Invalid end element(BNSNode): " + prefix + " != " + mPrefix + " || " + uri + " != " + mUri);
			System.out.println("Warning => Invalid end element(BNSNode): " + prefix + " != " + mPrefix + " || " + uri + " != " + mUri);
		}
	}
